...
$(".adDiet").html('<a href="#" class="d-flex align-items-center border m-1 text-dark shadow" style="text-decoration: none;background:#FFF8DC;"> <img src="../../products/food/oats/images/quakermain.jpg" loading="lazy" style="width: 100px;height:80px;" /> <div><h5 class="mx-2">Best Oats <i class="fa-solid fa-star text-warning"></i></h5> <p class="mx-2"><i class="fa-solid fa-store text-secondary"></i> Quaker</p></div></a>');

//____________AD-Coding______________
$(".adCoding").html('<a href="https://www.digitalocean.com/" class="d-flex align-items-center border m-1 text-dark shadow" style="text-decoration: none;background:#FFF8DC;"> <img src="../coding/images/digitalOcean.jfif" loading="lazy" style="width: 100px;height:80px;" /> <div><h5 class="mx-2">Best Hosting Service <i class="fa-solid fa-star text-warning"></i></h5> <p class="mx-2"><i class="fa-solid fa-store text-secondary"></i> Digital Ocean</p></div></a>');

//_________AD-Yoga__________
$(".adYoga").html('<a href="https://www.amazon.in/Hatha-Yoga-Pradipika-Muktibodhananda-Swami/dp/8185787387/ref=sr_1_3?keywords=hatha+yoga+pradipika&qid=1666456208&qu=eyJxc2MiOiIzLjEyIiwicXNhIjoiMS42NiIsInFzcCI6IjEuNjUifQ%3D%3D&sr=8-3" class="d-flex align-items-center border m-1 text-dark shadow" style="text-decoration: none;background:#FFF8DC;"> <img src="../people/images/hathayoga.jpg" loading="lazy" style="width: 100px;height:80px;" /> <div><h5 class="mx-2">Best Yoga Book <i class="fa-solid fa-star text-warning"></i></h5> <p class="mx-2"><i class="fa-solid fa-store text-secondary"></i> HathaYoga Pradipika</p></div></a>');

//_________AD-Vastu__________
$(".adVastu").html('<a href="https://www.patanjaliayurved.net/product/herbal-home-care/agarbatti-and-dhoops/aastha-dhoop-loban/896" class="d-flex align-items-center border m-1 text-dark shadow" style="text-decoration: none;background:#FFF8DC;"> <img src="../vastu/images/dhoop.jpg" loading="lazy" style="width: 100px;height:80px;" /> <div><h5 class="mx-2">Best Dhoop <i class="fa-solid fa-star text-warning"></i></h5> <p class="mx-2"><i class="fa-solid fa-store text-secondary"></i> Patanjali</p></div></a>');

//_________AD-Tech__________
$(".adTech").html('<a href="https://www.amazon.in/Redmi-Storage-Additional-Exchange-Available/dp/B09T2WPLS1/ref=sr_1_1?tag=8ap-21&th=1" target="_blank" class="d-flex align-items-center border m-1 text-dark shadow" style="text-decoration: none;background:#FFF8DC;"> <img src="../../../products/mobile/mobileunder20k/images/redmimain.jpg" loading="lazy" style="width: 100px;height:80px;" /> <div><h5 class="mx-2">Best Mobile (Redmi Note 11 Pro + 5G) <i class="fa-solid fa-star text-warning"></i></h5> <p class="mx-2"><i class="fa-solid fa-store text-secondary"></i> Amazon</p></div></a>');

//_________AD-Camera & Bikes__________
$(".adVehicle").html('<a href="https://www.heromotocorp.com/en-in/motorcycles/performance/xpulse-200t.html" target="_blank" class="d-flex align-items-center border m-1 text-dark shadow" style="text-decoration: none;background:#FFF8DC;"> <img src="../../products/bike/images/heromain.webp" loading="lazy" style="width: 100px;height:80px;" /> <div><h5 class="mx-2">Best Bike (Hero Xpulse 200T) <i class="fa-solid fa-star text-warning"></i></h5> <p class="mx-2"><i class="fa-solid fa-store text-secondary"></i> Hero Store</p></div></a>');

//_________AD-Food__________
$(".adFood").html('<a href="https://heygrain.in/products/ragi-oats-cookies?variant=42306839806120" target="_blank" class="d-flex align-items-center border m-1 text-dark shadow" style="text-decoration: none;background:#FFF8DC;"> <img src="../../../products/food/biscuit/images/heymain.jpg" loading="lazy" style="width: 100px;height:80px;" /> <div><h5 class="mx-2">Best Biscuits <i class="fa-solid fa-star text-warning"></i></h5> <p class="mx-2"><i class="fa-solid fa-store text-secondary"></i> Hey GrainStore</p></div></a>');

//_________AD-Movie__________
$(".adMovie").html('<a href="#" class="d-flex align-items-center border m-1 text-dark shadow" style="text-decoration: none;background:#ffd700;"> <img src="../../../images/static/ayurveda.png" loading="lazy" style="width: 100px;height:80px;" /> <div><h4 class="mx-2">Best Movie <i class="fa-solid fa-star text-warning"></i></h4> <p class="mx-2"><i class="fa-solid fa-store text-secondary"></i> Movie</p></div></a>');